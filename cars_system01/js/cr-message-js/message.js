...
$(function () {
    ...
    $(".now-money-ul li:nth-child(2)")[0].nowMoney = 10;
    $(".now-money-ul li:nth-child(3)")[0].nowMoney = 20;
    $(".now-money-ul li:nth-child(4)")[0].nowMoney = 50;
    $(".now-money-ul li:nth-child(5)")[0].nowMoney = 100;
    $(".now-money-ul li:nth-child(6)")[0].nowMoney = 200;
